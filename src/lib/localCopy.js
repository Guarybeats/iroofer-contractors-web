...
localCopy['roof-repair'] = {
  'dallas-ga': {
    intro: "A small drip in a Dallas attic rarely stays small. Ceiling stains, damp insulation, and peeling paint often trace back to worn flashing, cracked pipe boots, missing shingles, or a valley that's started to fail. Waiting through another rain cycle usually means more drywall repairs—and a bigger roof bill. iRoofer Contractors is family-owned in Dallas since 2019. We find the source, explain it clearly, and repair it the right way—whether it's a single penetration or a storm-weakened slope. Owner Cristian Mendez's licensed, bonded, and insured crew serves Paulding County homes with same-day options when your schedule and the leak both demand it.",
    sections: [
      ...
      { h: "Call now for same-day service in Dallas",
        p: "Call (470) 236-1410. Leaking, stained ceilings, or damaged shingles? Get a local Dallas crew on it today." },
    ],
    faq: [
...
localCopy['roof-replacement'] = {
  'dallas-ga': {
    intro: "When the third leak shows up in a year—or every repair quote starts sounding like a down payment on a new roof—it's time to talk replacement. Dallas homes often reach that point after years of Georgia sun, humidity, and storm seasons that bruise shingles slope by slope. iRoofer Contractors is family-owned in Dallas since 2019. Owner Cristian Mendez and our licensed, bonded, and insured team help you decide when replacement is the smarter investment, then install systems built for Paulding County weather. Clear scope, quality materials, and a local crew that finishes the job like it's their own home.",
    sections: [
      ...
      { h: "Call now for same-day service in Dallas",
        p: "Call (470) 236-1410. Ready to stop patching? Get a clear roof replacement plan from a Dallas crew you can trust." },
    ],
    faq: [
...
localCopy['storm-damage-roof-repair'] = {
  'dallas-ga': {
    ...
    sections: [
      ...
      { h: "Call now for same-day service in Dallas",
        p: "Call (470) 236-1410. Storm hit your roof? Don't wait for the next rain. Speak with Cristian's local crew today." },
    ],
    faq: [
