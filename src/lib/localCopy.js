...
localCopy['roof-repair'] = {
  'dallas-ga': {
    intro: "A small drip in a Dallas attic rarely stays small. Ceiling stains and soft spots often trace to worn flashing, cracked pipe boots, missing shingles, or a tired valley. iRoofer Contractors — family-owned in Dallas since 2019 — finds the source and handles the roof repair the right way. Owner Cristian Mendez. Licensed, bonded, insured.",
    sections: [
      { h: "Why local roof repair in Dallas",
        p: "Dallas and Paulding roofs deal with humidity, sudden storms, and plenty of tree cover—conditions that age flashing and asphalt faster than many homeowners expect. We're not a national call center; we're a local crew that shows up, walks the roof, and tells you what we see. Family-owned in Dallas since 2019, with owner Cristian Mendez on the line when decisions get complicated. As an Owens Corning Preferred contractor and CertainTeed Storm Restoration Specialist in Georgia, we repair to manufacturer standards and document damage when insurance may apply. You'll get honest scope: patch when a patch makes sense, recommend replacement when repairs would only buy a season. Call (470) 236-1410 or start at https://iroofercontractors.com/contact/." },
      { h: "How our Dallas roof repair process works",
        p: "Inspect — We check shingles, ridges, valleys, chimneys, step and wall flashing, vents, and pipe boots. Inside, we look for staining, soft decking signs, and attic moisture clues that point to the true leak path. Photo documentation — Problem areas are photographed so you (and your insurer, if relevant) can see the issue. Temporary protection — Active leaks can get tarped when needed. Written scope — materials, areas affected, and whether a targeted fix or larger work is smarter. Repair work — shingle replacement, flashing rebuilds, boot swaps, ridge repairs, sealing failed penetrations. Repair vs. replace — if patches keep failing, we'll say so and point you to /roof-replacement-dallas-ga/." },
      { h: "Roof leak repair in Dallas, GA",
        p: "Roof leak repair starts with the source — not the stain on the drywall. In Dallas homes we commonly find failed pipe boots, step flashing, valleys, and wind-lifted shingles feeding a slow drip into the attic. What you get: leak-path inspection (attic clues + roof), photos of the failure point, temporary tarp when water is active, a written scope for a targeted fix, and straight talk if replacement is smarter. Ceiling stain but no active drip? Often still worth a roof leak repair look if the mark grows after rain — don't wait for the next soak-through. Call (470) 236-1410 or https://iroofercontractors.com/contact/." },
      ...
      { h: "Related storm, claims, and emergency paths",
        p: "After wind or hail, see storm damage roof repair in Dallas. For adjuster documentation, use roof insurance claims help. Active water intrusion after a storm may need emergency tarping. Same licensed crew — clear next steps, no invented claim outcomes." },
    ],
    faq: [
      ...
      { q: "Can you repair a leaking roof the same day in Dallas, GA?", a: "Often yes for emergency leaks—especially tarping and urgent sealing when scheduling allows. Permanent repairs depend on material and weather. Call (470) 236-1410 and we'll prioritize when we can." },
      ...
      { q: "Ceiling stain but no active drip — still roof leak repair?", a: "Often yes if the mark grows after rain. Don't wait for the next soak-through. We'll trace the path from attic clues and the roof surface." },
    ],
  },
  'hiram': {
...
localCopy['roof-replacement'] = {
  'dallas-ga': {
    intro: "When patches stop making sense — third leak in a year, widespread wear, soft decking — it's time for roof replacement in Dallas, GA. iRoofer Contractors is family-owned here since 2019. Cristian Mendez's licensed, bonded, insured team helps you decide, then installs for Paulding County weather.",
    sections: [
      { h: "Why iRoofer for replacement",
        p: "Dallas-based (not storm-chasers). Family-owned since 2019 under Cristian Mendez, licensed, bonded, and insured. Owens Corning Preferred. CertainTeed Storm Restoration Specialist (GA) when storm path applies. Proper underlayment, flashing, ventilation — not just new shingles over old problems. If insurance is part of the conversation after storm damage, we document thoroughly and support the adjuster path when it applies—without promising claim results. Call (470) 236-1410 or https://iroofercontractors.com/contact/." },
  ...
  'hiram': {
    intro: "Most Hiram replacements are architectural shingle on homes from recent decades — the difference shows in decking repairs, valley protection, ventilation, and a clean tear-off. iRoofer Contractors is family-owned in nearby Dallas since 2019. Same licensed, bonded, insured crew. Cristian Mendez.",
    sections: [
      ...
      { h: "How a Hiram replacement works",
        p: "Inspect/measure → written proposal → tear-off → decking → underlayment/flashings → shingles/ridge → cleanup. Prefer a repair instead? See roof repair in Hiram. Call (470) 236-1410 or https://iroofercontractors.com/contact/." },
    ],
    faq: [
...
localCopy['storm-damage-roof-repair'] = {
  'dallas-ga': {
    intro: "After a Georgia storm, Dallas roofs often hide bruised shingles, lifted tabs, and quiet leaks that show up days later. iRoofer Contractors — family-owned since 2019 — walks the roof, photographs what we find, and explains repair versus replacement in plain English.",
    sections: [
      { h: "Why local storm repair",
        p: "Licensed, bonded, insured. Owens Corning Preferred. CertainTeed Storm Restoration Specialist (GA). We document the way adjusters expect — no promised claim outcomes. Owner Cristian Mendez and our Dallas-based crew treat storm calls like emergencies—not sales appointments. Call (470) 236-1410 or https://iroofercontractors.com/contact/." },
      ...
      { h: "Call now for storm response in Dallas",
        p: "Call (470) 236-1410. Storm hit your roof? Don't wait for the next rain. Speak with Cristian's local crew today for inspection, tarping, and claim documentation. https://iroofercontractors.com/contact/" },
    ],
    faq: [
      ...
      { q: "Do I always need a full replacement after hail?", a: "No — depends on how widespread the bruising is and the roof's age. We show you photos and put options in writing." },
      { q: "Should I file a claim for hail?", a: "Only if the damage and your deductible make sense — we'll say so honestly after we look." },
      { q: "Do you offer emergency roof repair after storms in Dallas?", a: "Yes. We prioritize active leaks with tarping when needed, then move into permanent repair or replacement once the scope is clear. Same-day service is available when scheduling allows—call now or see emergency roof repair Dallas." },
    ],
  },
  'hiram': {
...
localCopy['gutter-repair-replacement'] = {
  'dallas-ga': {
    intro: "Gutters are a small part of the roof system and a common way water ruins fascia and foundations. In Dallas we size runs to the roof that actually feeds them — not whatever the builder hung years ago. iRoofer Contractors, family-owned since 2019. Cristian Mendez. Licensed, bonded, insured. Shop at 152 Freedom Dr, Dallas, GA 30157 — the same local crew that roofs the house.",
    sections: [
      { h: "Capacity, not just condition",
        p: "Undersized 5\" runs and too few downspouts overshoot in Georgia downpours even when \"clean.\" We check roof area, fall, and outlets — and tell you if you need 6\", more downspouts, or realignment. Seamless aluminum formed on site means fewer leaky joints — the only joints are at corners and outlets." },
      { h: "Fascia rot — what it's telling you",
        p: "Soft fascia is a history of water behind the gutter (missing drip edge, hung above the shingle line). We don't bolt new gutter to rotten wood — we quote fascia separately and fix the detail that caused it. Gutter work does not require a permit in Paulding County, but replacing structural wood may, and we will tell you if your job reaches that point." },
      { h: "Repair vs replacement",
        p: "Loose hangers and minor seams often repair. Chronic overflow, separation, or systemic undersizing → replacement sized correctly. We measure rather than defaulting, then put the recommendation in writing." },
      { h: "Roof + gutter together",
        p: "Failing gutters soak eaves and can look like a \"roof leak.\" If stains track the perimeter, we check both — see also roof repair in Dallas. Call (470) 236-1410 or https://iroofercontractors.com/contact/." },
    ],
    faq: [
...
localCopy['new-construction'] = {
  'dallas-ga': {
    intro: "New Dallas builds deserve a roof crew that treats the site like a neighbor’s house — because it is. iRoofer Contractors installs new-construction roofs from our shop at 152 Freedom Dr, Dallas, GA 30157. Family-owned since 2019. Licensed, bonded, insured. Pair this page with /services/new-construction/ for the service overview. Ready to talk? https://iroofercontractors.com/contact/ or (470) 236-1410.",
    sections: [
