...
localCopy['roof-repair'] = {
  'dallas-ga': {
    intro: "A small drip in a Dallas attic rarely stays small. Ceiling stains, damp insulation, and peeling paint often trace back to worn flashing, cracked pipe boots, missing shingles, or a valley that's started to fail. Waiting through another rain cycle usually means more drywall repairs—and a bigger roof bill. iRoofer Contractors is family-owned out of 152 Freedom Dr, Dallas, GA 30157 since 2019. We find the source, explain it clearly, and repair it the right way—whether it's a single penetration or a storm-weakened slope. Owner Cristian Mendez's licensed, bonded, and insured crew serves Paulding County homes with same-day options when your schedule and the leak both demand it.",
    sections: [
      { h: "Why choose iRoofer for roof repair in Dallas",
        p: "Dallas and Paulding roofs deal with humidity, sudden storms, and plenty of tree cover—conditions that age flashing and asphalt faster than many homeowners expect. We're not a national call center; we're a local crew that shows up, walks the roof, and tells you what we see. Family-owned in Dallas since 2019, with owner Cristian Mendez on the line when decisions get complicated. As an Owens Corning Preferred contractor and CertainTeed Storm Restoration Specialist in Georgia, we repair to manufacturer standards and document damage when insurance may apply. You'll get honest scope: patch when a patch makes sense, recommend replacement when repairs would only buy a season. Neighbors hire us for ceiling stains, bad boots, and valley leaks—not hype. No fake guarantees—just clear findings, careful workmanship, and a direct line to the people doing the work: (470) 236-1410." },
      { h: "How our Dallas roof repair process works",
        p: "Inspection — We check shingles, ridges, valleys, chimneys, step and wall flashing, vents, and pipe boots. Inside, we look for staining, soft decking signs, and attic moisture clues that point to the true leak path. Photo documentation — Problem areas are photographed so you (and your insurer, if relevant) can see the issue—not just hear about it. Temporary protection — Active leaks can get tarped when needed so the next storm doesn't soak the interior while parts and scheduling line up. Written scope — You receive a clear outline of repairs: materials, areas affected, and whether a targeted fix or a larger section replacement is smarter for your roof's age and condition. Repair work — Typical Dallas jobs include shingle replacement, flashing rebuilds, boot swaps, ridge repairs, and sealing failed penetrations. We match materials where practical and clean the site when we're done. Repair vs. replace — If patches keep failing or the roof is near end of life across multiple slopes, we'll say so and discuss replacement options—including how that ties to warranties from Owens Corning or CertainTeed systems when those apply. Call for same-day roof repair service in Dallas when availability allows." },
      { h: "Paulding County details that change the repair",
        p: "Paulding County Building & Permitting (240 Constitution Blvd, Dallas) requires a permit for roofing when the work is structural — sheathing, rafters, or trusses — not for routine shingle and flashing repairs above the deck. We check layer count and deck condition during the inspection so you know before tools come out. Based at 152 Freedom Dr, we stage materials locally and can often tarp the same day when water is actively entering. If the roof is past targeted repairs, we will point you to a full replacement conversation rather than stacking patches." },
      { h: "Call now for same-day service in Dallas",
        p: "Call (470) 236-1410. Leaking, stained ceilings, or damaged shingles? Get a local Dallas crew on it today — or request a free inspection and written scope with no pressure to replace." },
    ],
    faq: [
  ...
  'hiram': {
    ...
    sections: [
      { h: "Why choose iRoofer for roof repair in Hiram",
        p: "Hiram and broader Paulding neighborhoods often sit under mature tree cover. That shade is nice; the leaf debris, falling limbs, and storm-driven branches are harder on valleys, gutters, and asphalt. We're a local crew based in nearby Dallas since 2019—not a rotating franchise van—led by owner Cristian Mendez and licensed, bonded, and insured for Georgia residential work. Owens Corning Preferred and a CertainTeed Storm Restoration Specialist in Georgia, so repairs follow manufacturer details when it matters for warranties and longevity. For storm-related damage, we photograph findings and can support the insurance adjuster path when a claim applies. We won't invent guarantees about claim approval or \"lifetime\" fixes; we will give you honest scope, careful workmanship, and a phone number answered by people who know Paulding: (470) 236-1410." },
      { h: "How our Hiram roof repair process works",
        p: "Inspect — Shingles, ridges, valleys, wall and chimney flashing, vents, and pipe boots. We also note soft spots, granule loss patterns, and interior clues (stains, attic dampness) common after Hiram storms. Wooded lots get an extra look at valleys and drip edges where debris holds moisture. Photograph — Clear images of each issue for your records—and for insurers when wind or hail is involved. Tarp if needed — Active leaks get temporary protection so the house stays dry while permanent materials and scheduling lock in. Scope — Written outline of repairs vs. larger work. Tree-limb punctures, lifted tabs, and failed flashing are frequent Hiram calls; we size the fix to the damage and explain what's urgent versus what can wait a few days. Repair / replace decision — Targeted repair when the rest of the roof is sound. If wear is widespread or the system is near end of life, we'll discuss replacement—including options on our Hiram replacement page—without pressure. Complete & clean — Licensed install to solid flashing and shingle details, magnetic nail sweep, site cleanup, and plain-language next steps. Same-day service in Hiram is available when the schedule allows—call early after a storm for the best chance of a same-day slot." },
      { h: "Call now for same-day service in Hiram",
        p: "Call (470) 236-1410. Leak, storm damage, or failing flashing? Get a Paulding County crew out today." },
    ],
    faq: [
...
localCopy['roof-replacement'] = {
  'dallas-ga': {
    intro: "When the third leak shows up in a year—or every repair quote starts sounding like a down payment on a new roof—it's time to talk replacement. Dallas homes often reach that point after years of Georgia sun, humidity, and storm seasons that bruise shingles slope by slope. iRoofer Contractors is family-owned at 152 Freedom Dr, Dallas, GA 30157 since 2019. Owner Cristian Mendez and our licensed, bonded, and insured team help you decide when replacement is the smarter investment, then install systems built for Paulding County weather. Clear scope, Owens Corning Preferred Contractor standards, and a local crew that finishes the job like it's their own home.",
    sections: [
      { h: "Why choose iRoofer for roof replacement in Dallas",
        p: "We're a Dallas-based roofing company—not a storm-chaser passing through. Family-owned since 2019 under Cristian Mendez, licensed, bonded, and insured for Paulding County work. As an Owens Corning Preferred contractor and a CertainTeed Storm Restoration Specialist in Georgia, we install systems with manufacturer-backed warranties when your project qualifies. That means proper underlayment, flashing details, and ventilation—not just new shingles over old problems. We walk Dallas and Paulding homeowners through tear-off vs. limited overlay (when code and condition allow), material choices, budget ranges, and timeline expectations without pressure. Crews protect landscaping access, keep communication clear on start and finish days, and leave the site clean. If insurance is part of the conversation after storm damage, we document thoroughly and support the adjuster path when it applies—without promising claim results. One phone number, one local owner: (470) 236-1410." },
      { h: "How a Dallas roof replacement works",
        p: "When replacement makes sense — Repeated leaks, widespread shingle bruising, curling or missing tabs across multiple slopes, soft decking, or a roof near or past expected lifespan. Inspection & estimate — We measure, photograph, and check decking, flashing, and ventilation. You get a written proposal covering tear-off, disposal, underlayment, shingles, flashings, and ridge/vent details. Material guidance — Options typically include architectural asphalt systems from Owens Corning and CertainTeed lines suited to Georgia climate. Project process — Protect landscaping and property access, tear off to deck (or as scoped), repair bad decking, install underlayment and ice/water where needed, set flashings correctly, install shingles, ridge, and vents, then clean magnets and debris. Storm & insurance path — If hail or wind contributed, we document patterns and can meet the adjuster when scheduled. Aftercare — Walkthrough of completed work, warranty paperwork, and maintenance tips so your new Dallas roof lasts. Ask about scheduling and same-week starts when materials and weather align." },
      ...
      { h: "Call now for a Dallas replacement plan",
        p: "Call (470) 236-1410. Ready to stop patching? Get a clear roof replacement plan from a Dallas crew you can trust — free inspection, written scope, zero pressure." },
    ],
    faq: [
      { q: "How long does a roof replacement take in Dallas, GA?", a: "Many single-family homes finish in one to two days once materials are on site, depending on size, pitch, decking repairs, and weather. We'll give a realistic schedule after inspection." },
...
localCopy['storm-damage-roof-repair'] = {
  'dallas-ga': {
    intro: "After a Georgia storm, Dallas roofs often show problems that aren't obvious from the ground—bruised shingles, lifted tabs, blown-off ridge caps, and quiet leaks that show up days later as ceiling stains. The clock matters: insurers typically expect prompt documentation, and moisture left alone can spread into decking and insulation. iRoofer Contractors is a family-owned crew based at 152 Freedom Dr, Dallas, GA 30157 (since 2019) that responds locally when Paulding County weather hits hard. We walk the roof, photograph what we find, and explain repair versus replacement in plain English—so you're not guessing what the storm actually did or how soon you need to act.",
    sections: [
      { h: "Why choose iRoofer for storm damage roof repair in Dallas",
        p: "We're based in Dallas and work Paulding County homes every week, so we know how local storms and tree cover punish asphalt shingles and flashing. Owner Cristian Mendez and our licensed, bonded, and insured team treat storm calls like emergencies—not sales appointments. As an Owens Corning Preferred contractor and a CertainTeed Storm Restoration Specialist in Georgia, we document damage the way manufacturers and adjusters expect: clear photos, notes on wind vs. impact patterns, and a written scope you can share. When a claim applies, we help you understand the adjuster path—what's typically covered, what to ask, and how to avoid leaving valid storm damage off the report. We don't promise outcomes we can't control; we do promise honest findings, careful workmanship, and a local phone number that picks up: (470) 236-1410." },
      { h: "Our storm damage process in Dallas, GA",
        p: "1. Inspect — We check shingles, valleys, flashings, vents, ridge, and penetrations for wind lift, bruising, punctures, and soft decking. Interior stains and attic moisture get noted too. 2. Photo documentation — Every problem area is photographed for your records and, when relevant, for your insurer. 3. Emergency tarp (if needed) — Active leaks or open decking get temporary protection so rain doesn't keep pouring into the home while materials and approvals line up. 4. Scope of work — You get a written outline: what's damaged, what's recommended, and whether a targeted repair or full replacement makes more sense. 5. Repair vs. replace — Isolated missing shingles or flashing failures often repair cleanly. Widespread bruising, multiple slopes hit, or an older roof near end of life may point to replacement. 6. Complete the work — Licensed crews install to manufacturer guidelines, clean the site, and leave you with clear next steps—including warranty and claim paperwork support when it applies. For urgent leaks after a storm, ask about same-day response in Dallas and nearby Paulding communities." },
      { h: "Why Paulding storm cells hit Dallas hard",
        p: "Paulding sits where west Georgia storm cells organize before they reach Atlanta — straight-line wind that strips slopes and lifts ridge caps, hail that bruises mats without breaking them, and tree-limb strikes on wooded lots. We photograph with dates, check soft metals (vents, gutter aprons) for impact dents, and meet your adjuster on the roof when a claim applies. Active leaks get same-day tarping from our Dallas shop when weather and access allow. If the damage does not support a claim, we say so and quote the repair directly." },
      { h: "Call now for same-day storm response in Dallas",
        p: "Call (470) 236-1410. Storm hit your roof? Don't wait for the next rain. Speak with Cristian's local crew today for inspection, tarping, and claim documentation." },
    ],
    faq: [
      { q: "How soon after a storm should I get my Dallas roof inspected?", a: "As soon as it's safe. Hidden bruising and lifted shingles can leak on the next rain. Prompt photos also help if you file a claim. Call (470) 236-1410 for a Dallas inspection." },
...
localCopy['gutter-repair-replacement'] = {
  'dallas-ga': {
    intro: "Gutters are the cheapest part of your roof system and the one most likely to cost you a foundation. In Dallas we size them to the roof that is actually feeding them rather than to whatever the builder put up. iRoofer Contractors works gutters from our shop at 152 Freedom Dr, Dallas, GA 30157 — the same local crew that roofs the house, so drip edge, fascia, and downspouts get treated as one water system.",
    sections: [
