...
export const metadata = seo({
  title: "Storm Damage Roof Repair in Acworth, GA | iRoofer Contractors",
  description: "Storm Damage Roof Repair in Acworth, GA — Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/storm-damage-roof-repair-acworth',
});

const faqs = [
  {
    "q": "Do you offer storm damage roof repair in Acworth, GA?",
    "a": "Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Acworth lakefront and in-town homes alike call us for fast leak tracing and clean tear-offs."
  },
  {
    "q": "How fast can you start a storm damage roof repair job in Acworth?",
    "a": "Most Acworth jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."
  },
  {
  ...
  {
    "q": "What does storm damage roof repair cost in Acworth, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                Storm Damage Roof Repair in Acworth, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. In Acworth, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/storm-damage.webp" alt="Storm Damage Roof Repair in Acworth, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="storm-damage-roof-repair-acworth-quote" source="Storm Damage Roof Repair Acworth GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Acworth, GA Storm Damage Roof Repair FAQ</span>
            <h2>Questions Acworth homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer storm damage roof repair in Acworth, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Acworth lakefront and in-town homes alike call us for fast leak tracing and clean tear-offs."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a storm damage roof repair job in Acworth?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Most Acworth jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does storm damage roof repair cost in Acworth, GA?"}<span className="pm" aria-hidden="true" /></button>
        ...
        <div className="wrap">
          ...
          <div className="cards" style={{ gridTemplateColumns: 'repeat(auto-fill,minmax(230px,1fr))' }}>
            <Link key="roof-repair" href="/roof-repair-acworth" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Roof Repair in Acworth</h4>
            ...
            <Link key="roof-replacement" href="/roof-replacement-acworth" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Roof Replacement in Acworth</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
            <Link key="new-construction" href="/new-construction-acworth" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>New Construction in Acworth</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
            <Link key="gutter-repair-replacement" href="/gutter-repair-replacement-acworth" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Gutter Repair & Replacement in Acworth</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
          </div>
        </div>
