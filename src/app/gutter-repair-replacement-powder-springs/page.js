...
export const metadata = seo({
  title: "Gutter Repair & Replacement in Powder Springs, GA | iRoofer Contractors",
  description: "Gutter Repair & Replacement in Powder Springs, GA — Clogged or failing gutters are the #1 cause of preventable roof and foundation damage. We repair, realign, and replace. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/gutter-repair-replacement-powder-springs',
});

const faqs = [
  {
    "q": "Do you offer gutter repair & replacement in Powder Springs, GA?",
    "a": "Yes. Gutter Repair & Replacement is one of our core services across Cobb County and the greater Atlanta metro. In Powder Springs we handle everything from single-slope ranch reroofs to steep two-story tear-offs."
  },
  {
    "q": "How fast can you start a gutter repair & replacement job in Powder Springs?",
    "a": "Most Powder Springs jobs are scheduled within 24–72 hours after a free inspection. Emergency leaks get priority scheduling."
  },
  {
  ...
  {
    "q": "What does gutter repair & replacement cost in Powder Springs, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                Gutter Repair & Replacement in Powder Springs, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Clogged or failing gutters are the #1 cause of preventable roof and foundation damage. We repair, realign, and replace. In Powder Springs, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-gutters-main.webp" alt="Gutter Repair & Replacement in Powder Springs, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="gutter-repair-replacement-powder-springs-quote" source="Gutter Repair & Replacement Powder Springs GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Powder Springs, GA Gutter Repair & Replacement FAQ</span>
            <h2>Questions Powder Springs homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer gutter repair & replacement in Powder Springs, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Gutter Repair & Replacement is one of our core services across Cobb County and the greater Atlanta metro. In Powder Springs we handle everything from single-slope ranch reroofs to steep two-story tear-offs."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a gutter repair & replacement job in Powder Springs?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Most Powder Springs jobs are scheduled within 24–72 hours after a free inspection. Emergency leaks get priority scheduling."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does gutter repair & replacement cost in Powder Springs, GA?"}<span className="pm" aria-hidden="true" /></button>
        ...
        <div className="wrap">
          ...
          <div className="cards" style={{ gridTemplateColumns: 'repeat(auto-fill,minmax(230px,1fr))' }}>
            <Link key="roof-repair" href="/roof-repair-powder-springs" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Roof Repair in Powder Springs</h4>
            ...
            <Link key="roof-replacement" href="/roof-replacement-powder-springs" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Roof Replacement in Powder Springs</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
            <Link key="new-construction" href="/new-construction-powder-springs" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>New Construction in Powder Springs</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
            <Link key="storm-damage-roof-repair" href="/storm-damage-roof-repair-powder-springs" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Storm Damage Roof Repair in Powder Springs</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
          </div>
        </div>
