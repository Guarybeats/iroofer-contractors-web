...
export const metadata = seo({
  ...
  description: 'Gutter repair and replacement in Austell, GA. We fix clogged, sagging and leaking gutters before they damage your roof. Free inspection: (470) 236-1410.',
...
const copy = localCopy['gutter-repair-replacement']['austell'];
const faqs = copy.faq;
      ...
      <section className="sec-light sec-pad">
        ...
        <div className="wrap" style={{ position: 'relative' }}>
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            ...
            <div className="rv">
              <img src="/assets/service-gutters-main.webp?v=2" alt="Gutter Repair & Replacement in Austell, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
