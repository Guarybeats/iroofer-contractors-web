...
const faqs = [
  {
    "q": "Do you offer roof repair in Kennesaw, GA?",
    "a": "Yes. Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Kennesaw homeowners and small businesses rely on us for honest pricing and a real person on the phone."
  },
  {
    "q": "How fast can you start a roof repair job in Kennesaw?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                From storm damage to worn flashing, we find the source and fix it right — so a small problem stays small. In Kennesaw, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-repair.webp?v=2" alt="Roof Repair in Kennesaw, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
        ...
        <div className="wrap">
          ...
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof repair in Kennesaw, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Kennesaw homeowners and small businesses rely on us for honest pricing and a real person on the phone."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof repair job in Kennesaw?"}<span className="pm" aria-hidden="true" /></button>
