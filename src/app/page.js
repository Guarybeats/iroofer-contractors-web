...
const reviews = [
  { q: '“After the last storm a branch punched a hole in our roof. iRoofer had a tarp up the same afternoon and the full replacement done before the next round of rain. Honest people.”', who: 'Marcus T.', where: 'Dallas, GA' },
  { q: '“Crew showed up at 7am, finished by dusk, and you’d never know they were here — not a single nail in the yard. The walkthrough at the end won us over.”', who: 'Dana R.', where: 'Douglasville, GA' },
  { q: '“Got three quotes. iRoofer wasn’t the cheapest, but they were the only ones who actually climbed on the roof and showed me photos. Worth every dollar.”', who: 'Priya S.', where: 'Hiram, GA' },
  { q: '“They replaced our roof and the gutters in the same week. Honest, fast, and they texted updates the whole time.”', who: 'Jon & Amy K.', where: 'Powder Springs, GA' },
  { q: '“Needed a repair before closing on the house. iRoofer came out next day, fair price, and the sale went through. Lifesavers.”', who: 'Lena O.', where: 'Marietta, GA' },
  { q: '“Family-run and it shows. They did my parents’ roof 12 years ago and mine last spring — same quality, same phone number.”', who: 'Colt W.', where: 'Kennesaw, GA' },
  { q: '“The estimator explained why my old three-tab shingles failed early. No upsell, just facts. New architectural roof looks incredible.”', who: 'Tyler B.', where: 'Acworth, GA' },
  { q: '“We manage a few rentals and iRoofer is the only roofer we call now. Fair pricing, zero callbacks, photos before and after every job.”', who: 'Renee F.', where: 'Austell, GA' },
];
