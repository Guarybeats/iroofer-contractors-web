...
export const metadata = seo({
  title: "Roof Repair in Acworth, GA | iRoofer Contractors",
  description: "Roof Repair in Acworth, GA — From storm damage to worn flashing, we find the source and fix it right — so a small problem stays small. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/roof-repair-acworth',
});

const faqs = [
  {
    "q": "Do you offer roof repair in Acworth, GA?",
    "a": "Yes. Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Acworth lakefront and in-town homes alike call us for fast leak tracing and clean tear-offs."
  },
  {
    "q": "How fast can you start a roof repair job in Acworth?",
  ...
  {
    "q": "What does roof repair cost in Acworth, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                From storm damage to worn flashing, we find the source and fix it right — so a small problem stays small. In Acworth, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-repair.webp" alt="Roof Repair in Acworth, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="roof-repair-acworth-quote" source="Roof Repair Acworth GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Acworth, GA Roof Repair FAQ</span>
            <h2>Questions Acworth homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof repair in Acworth, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Acworth lakefront and in-town homes alike call us for fast leak tracing and clean tear-offs."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof repair job in Acworth?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does roof repair cost in Acworth, GA?"}<span className="pm" aria-hidden="true" /></button>
