...
export const metadata = seo({
  title: "Roof Replacement in Marietta, GA | iRoofer Contractors",
  description: "Roof Replacement in Marietta, GA — Full tear-off and replacement with architectural asphalt shingles installed by an Owens Corning Preferred Contractor, installed clean and built to last. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/roof-replacement-marietta',
});

const faqs = [
  {
    "q": "Do you offer roof replacement in Marietta, GA?",
    "a": "Yes. Roof Replacement is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."
  },
  {
    "q": "How fast can you start a roof replacement job in Marietta?",
  ...
  {
    "q": "What does roof replacement cost in Marietta, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Full tear-off and replacement with architectural asphalt shingles installed by an Owens Corning Preferred Contractor, installed clean and built to last. In Marietta, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-replacement.webp" alt="Roof Replacement in Marietta, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="roof-replacement-marietta-quote" source="Roof Replacement Marietta GA" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="wrap">
          ...
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof replacement in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Replacement is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof replacement job in Marietta?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does roof replacement cost in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
