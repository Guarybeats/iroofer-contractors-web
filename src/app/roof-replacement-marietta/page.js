...
export const metadata = seo({
  ...
  description: "Roof Replacement in Marietta, GA — Full tear-off and replacement with GAF-certified architectural asphalt shingles, installed clean and built to last. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Full tear-off and replacement with GAF-certified architectural asphalt shingles, installed clean and built to last. In Marietta, GA (Cobb County) we bring the same local crew, the same warranty,
