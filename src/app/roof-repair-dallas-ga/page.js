...
export const metadata = seo({
  title: "Roof Repair in Dallas, GA | iRoofer Contractors",
  description: "Roof Repair in Dallas, GA — From storm damage to worn flashing, we find the source and fix it right — so a small problem stays small. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/roof-repair-dallas-ga',
});

const faqs = [
  {
    "q": "Do you offer roof repair in Dallas, GA?",
    "a": "Yes. Roof Repair is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."
  },
  {
    "q": "How fast can you start a roof repair job in Dallas?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                From storm damage to worn flashing, we find the source and fix it right — so a small problem stays small. In Dallas, GA (Paulding County) we bring the same local crew, the same warranty,
              ...
              <p style={{ color: '#52606b', fontSize: '.98rem', marginTop: 12, maxWidth: 680, borderLeft: '3px solid var(--orange)', paddingLeft: 12 }}>
                Local note: we&apos;ve repaired roofs across the older subdivisions near downtown Dallas and the newer builds out toward the Paulding/Cobb line — from granule loss after spring hail to lifted shingles off the ridge winds. Most repairs here are completed in a single visit.
              </p>
            ...
            <div className="rv">
              <img src="/assets/service-repair.webp?v=2" alt="Roof Repair in Dallas, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="roof-repair-dallas-ga-quote" source="Roof Repair Dallas GA" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="wrap">
          ...
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof repair in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Repair is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof repair job in Dallas?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does roof repair cost in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
