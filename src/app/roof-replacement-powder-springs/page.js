...
const faqs = [
  {
    "q": "Do you offer roof replacement in Powder Springs, GA?",
    "a": "Yes. Roof Replacement is one of our core services across Cobb County and the greater Atlanta metro. In Powder Springs we handle everything from single-slope ranch reroofs to steep two-story tear-offs."
  },
  {
    "q": "How fast can you start a roof replacement job in Powder Springs?",
  ...
  {
    "q": "What does roof replacement cost in Powder Springs, GA?",
      ...
      <section className="sec-light sec-pad">
        ...
        <div className="wrap" style={{ position: 'relative' }}>
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            ...
            <div className="rv">
              <img src="/assets/service-replacement.webp" alt="Roof Replacement in Powder Springs, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="roof-replacement-powder-springs-quote" source="Roof Replacement Powder Springs GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Powder Springs, GA Roof Replacement FAQ</span>
            <h2>Questions Powder Springs homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof replacement in Powder Springs, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Replacement is one of our core services across Cobb County and the greater Atlanta metro. In Powder Springs we handle everything from single-slope ranch reroofs to steep two-story tear-offs."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof replacement job in Powder Springs?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does roof replacement cost in Powder Springs, GA?"}<span className="pm" aria-hidden="true" /></button>
