...
export const metadata = seo({
  title: "Storm Damage Roof Repair in Kennesaw, GA | iRoofer Contractors",
  description: "Storm Damage Roof Repair in Kennesaw, GA — Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/storm-damage-roof-repair-kennesaw',
});

const faqs = [
  {
    "q": "Do you offer storm damage roof repair in Kennesaw, GA?",
    "a": "Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Kennesaw homeowners and small businesses rely on us for honest pricing and a real person on the phone."
  },
  {
    "q": "How fast can you start a storm damage roof repair job in Kennesaw?",
    "a": "Most Kennesaw jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."
  },
  {
  ...
  {
    "q": "What does storm damage roof repair cost in Kennesaw, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. In Kennesaw, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/storm-damage.webp" alt="Storm Damage Roof Repair in Kennesaw, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="storm-damage-roof-repair-kennesaw-quote" source="Storm Damage Roof Repair Kennesaw GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Kennesaw, GA Storm Damage Roof Repair FAQ</span>
            <h2>Questions Kennesaw homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer storm damage roof repair in Kennesaw, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Kennesaw homeowners and small businesses rely on us for honest pricing and a real person on the phone."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a storm damage roof repair job in Kennesaw?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Most Kennesaw jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does storm damage roof repair cost in Kennesaw, GA?"}<span className="pm" aria-hidden="true" /></button>
