...
export const metadata = seo({
  ...
  description: 'Roof replacement in Dallas, GA by an Owens Corning Preferred Contractor. Tear-off, architectural shingles, clean site. Free inspection: (470) 236-1410.',
  path: '/roof-replacement-dallas-ga',
});

const faqs = [
  {
    "q": "Do you offer roof replacement in Dallas, GA?",
    "a": "Yes. Roof Replacement is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."
  },
  {
    "q": "How fast can you start a roof replacement job in Dallas?",
  ...
  {
    "q": "What does roof replacement cost in Dallas, GA?",
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Dallas, GA Roof Replacement FAQ</span>
            <h2>Questions Dallas homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer roof replacement in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Roof Replacement is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a roof replacement job in Dallas?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does roof replacement cost in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
