...
export const metadata = seo({
  title: "New Construction in Douglasville, GA | iRoofer Contractors",
  description: "New Construction in Douglasville, GA — We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/new-construction-douglasville',
});

const faqs = [
  {
    "q": "Do you offer new construction in Douglasville, GA?",
    "a": "Yes. New Construction is one of our core services across Douglas County and the greater Atlanta metro. Douglasville sees its share of spring straight-line winds off the ridge — we document hail and wind damage for your claim."
  },
  {
    "q": "How fast can you start a new construction job in Douglasville?",
  ...
  {
    "q": "What does new construction cost in Douglasville, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                New Construction in Douglasville, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. In Douglasville, GA (Douglas County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-newconstruction.webp" alt="New Construction in Douglasville, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="new-construction-douglasville-quote" source="New Construction Douglasville GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Douglasville, GA New Construction FAQ</span>
            <h2>Questions Douglasville homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer new construction in Douglasville, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. New Construction is one of our core services across Douglas County and the greater Atlanta metro. Douglasville sees its share of spring straight-line winds off the ridge — we document hail and wind damage for your claim."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a new construction job in Douglasville?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does new construction cost in Douglasville, GA?"}<span className="pm" aria-hidden="true" /></button>
