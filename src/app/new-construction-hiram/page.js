...
export const metadata = seo({
  ...
  description: "New Construction in Hiram, GA — We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/new-construction-hiram',
});

const faqs = [
  {
    "q": "Do you offer new construction in Hiram, GA?",
    "a": "Yes. New Construction is one of our core services across Paulding County and the greater Atlanta metro. Hiram families trust us for architectural shingle replacements that match the neighborhood and hold up to Georgia summers."
  },
  {
    "q": "How fast can you start a new construction job in Hiram?",
  ...
  {
    "q": "What does new construction cost in Hiram, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                New Construction in Hiram, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. In Hiram, GA (Paulding County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-newconstruction.webp" alt="New Construction in Hiram, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="new-construction-hiram-quote" source="New Construction Hiram GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Hiram, GA New Construction FAQ</span>
            <h2>Questions Hiram homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer new construction in Hiram, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. New Construction is one of our core services across Paulding County and the greater Atlanta metro. Hiram families trust us for architectural shingle replacements that match the neighborhood and hold up to Georgia summers."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a new construction job in Hiram?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does new construction cost in Hiram, GA?"}<span className="pm" aria-hidden="true" /></button>
