...
export const metadata = seo({
  title: "New Construction in Marietta, GA | iRoofer Contractors",
  description: "New Construction in Marietta, GA — We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/new-construction-marietta',
});

const faqs = [
  {
    "q": "Do you offer new construction in Marietta, GA?",
    "a": "Yes. New Construction is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."
  },
  {
    "q": "How fast can you start a new construction job in Marietta?",
  ...
  {
    "q": "What does new construction cost in Marietta, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                New Construction in Marietta, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                We partner with builders and homeowners on new builds to install a roof that matches the design and the budget. In Marietta, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-newconstruction.webp" alt="New Construction in Marietta, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
              <div style={{ maxWidth: 460, margin: 0 }}>
                <QuoteForm variant="contact" id="new-construction-marietta-quote" source="New Construction Marietta GA" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Marietta, GA New Construction FAQ</span>
            <h2>Questions Marietta homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer new construction in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. New Construction is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a new construction job in Marietta?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does new construction cost in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
