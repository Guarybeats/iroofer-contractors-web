...
export const metadata = seo({
  ...
  description: 'Storm damage roof repair in Austell, GA. We inspect hail and wind damage, document it, and handle your insurance claim. Free inspection: (470) 236-1410.',
...
const copy = localCopy['storm-damage-roof-repair']['austell'];
const faqs = copy.faq;
      ...
      <section className="sec-light sec-pad">
        ...
        <div className="wrap" style={{ position: 'relative' }}>
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            ...
            <div className="rv">
              <img src="/assets/storm-damage.webp?v=2" alt="Storm Damage Roof Repair in Austell, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
