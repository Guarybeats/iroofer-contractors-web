      ...
      <section className="sec-light sec-pad">
        ...
        <div className="wrap" style={{ position: 'relative' }}>
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            ...
            <div className="rv">
              <img src="/assets/service-repair.webp?v=3" alt="Roof Repair in Hiram, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
