...
export const metadata = {
  alternates: { canonical: 'https://iroofercontractors.com/service-areas/austell' },
  openGraph: { url: 'https://iroofercontractors.com/service-areas/austell' },

  title: 'Austell, GA Roof Repair & Replacement — Free Estimates | iRoofer',
  description:
...
const city = {
  ...
  state: 'GA',
  county: 'Cobb County',
  blurb: 'emergency tarping and honest estimates for Austell property owners.',
        ...
        <div className="faq-grid" style={{ marginTop: 44, alignItems: 'start' }}>
          ...
          <div className="rv">
            <picture>
              ...
              <img src="/assets/hero.webp" alt="Roofing work in Austell, GA" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%' }} />
            </picture>
