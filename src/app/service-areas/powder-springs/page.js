...
export const metadata = {
  ...
  title: 'Powder Springs, GA Roof Repair & Replacement — Free Estimates | iRoofer',
  description:
        ...
        <div className="faq-grid" style={{ marginTop: 44, alignItems: 'start' }}>
          ...
          <div className="rv">
            <picture>
              ...
              <img src="/assets/hero.jpg" alt="Roofing work in Powder Springs, GA" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%' }} />
            </picture>
