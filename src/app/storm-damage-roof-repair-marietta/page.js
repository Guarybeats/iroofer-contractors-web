...
export const metadata = seo({
  title: "Storm Damage Roof Repair in Marietta, GA | iRoofer Contractors",
  description: "Storm Damage Roof Repair in Marietta, GA — Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/storm-damage-roof-repair-marietta',
});

const faqs = [
  {
    "q": "Do you offer storm damage roof repair in Marietta, GA?",
    "a": "Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."
  },
  {
    "q": "How fast can you start a storm damage roof repair job in Marietta?",
    "a": "Most Marietta jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."
  },
  {
  ...
  {
    "q": "What does storm damage roof repair cost in Marietta, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. In Marietta, GA (Cobb County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/storm-damage.webp" alt="Storm Damage Roof Repair in Marietta, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
        ...
        <div className="wrap">
          ...
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer storm damage roof repair in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Storm Damage Roof Repair is one of our core services across Cobb County and the greater Atlanta metro. Marietta’s mix of historic homes and new builds means we tailor every scope to the property."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a storm damage roof repair job in Marietta?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Most Marietta jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does storm damage roof repair cost in Marietta, GA?"}<span className="pm" aria-hidden="true" /></button>
        ...
        <div className="wrap">
          ...
          <div className="cards" style={{ gridTemplateColumns: 'repeat(auto-fill,minmax(230px,1fr))' }}>
            ...
            <Link key="gutter-repair-replacement" href="/gutter-repair-replacement-marietta" className="svc-card">
              <h4 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Gutter Repair & Replacement in Marietta</h4>
              <span className="arr" style={{ color: 'var(--orange)', fontWeight: 800, marginTop: 12, display: 'inline-block' }}>View →</span>
            </Link>
          </div>
        </div>
