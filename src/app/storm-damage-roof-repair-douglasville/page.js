...
export const metadata = seo({
  title: "Storm Damage Roof Repair in Douglasville, GA | iRoofer Contractors",
  description: "Storm Damage Roof Repair in Douglasville, GA — Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/storm-damage-roof-repair-douglasville',
});

const faqs = [
  {
    "q": "Do you offer storm damage roof repair in Douglasville, GA?",
    "a": "Yes. Storm Damage Roof Repair is one of our core services across Douglas County and the greater Atlanta metro. Douglasville sees its share of spring straight-line winds off the ridge — we document hail and wind damage for your claim."
  },
  {
    "q": "How fast can you start a storm damage roof repair job in Douglasville?",
    "a": "Most Douglasville jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."
  },
  {
  ...
  {
    "q": "What does storm damage roof repair cost in Douglasville, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <h1 style={{ fontSize: 'clamp(2.4rem,5vw,4rem)', fontWeight: 900, lineHeight: 1.02, marginTop: 8 }}>
                Storm Damage Roof Repair in Douglasville, GA
              </h1>
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Hail, wind, or tree damage from a Georgia storm? We inspect, document storm damage, and handle your insurance claim. In Douglasville, GA (Douglas County) we bring the same local crew, the same warranty,
      ...
      <section className="sec-light sec-pad" style={{ paddingTop: 0 }}>
        <div className="wrap">
          <div className="sec-head rv">
            <span className="eyebrow dark">Douglasville, GA Storm Damage Roof Repair FAQ</span>
            <h2>Questions Douglasville homeowners ask us</h2>
          </div>
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer storm damage roof repair in Douglasville, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Storm Damage Roof Repair is one of our core services across Douglas County and the greater Atlanta metro. Douglasville sees its share of spring straight-line winds off the ridge — we document hail and wind damage for your claim."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a storm damage roof repair job in Douglasville?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Most Douglasville jobs are scheduled within 24–72 hours after a free inspection. For active storm leaks we offer same-day tarping."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does storm damage roof repair cost in Douglasville, GA?"}<span className="pm" aria-hidden="true" /></button>
