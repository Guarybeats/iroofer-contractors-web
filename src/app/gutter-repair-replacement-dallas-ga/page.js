...
export const metadata = seo({
  ...
  description: "Gutter Repair & Replacement in Dallas, GA — Clogged or failing gutters are the #1 cause of preventable roof and foundation damage. We repair, realign, and replace. Local, family-owned, 5★ on Google, free inspection. Call (470) 236-1410.",
  path: '/gutter-repair-replacement-dallas-ga',
});

const faqs = [
  {
    "q": "Do you offer gutter repair & replacement in Dallas, GA?",
    "a": "Yes. Gutter Repair & Replacement is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."
  },
  {
    "q": "How fast can you start a gutter repair & replacement job in Dallas?",
  ...
  {
    "q": "What does gutter repair & replacement cost in Dallas, GA?",
          ...
          <div className="faq-grid" style={{ alignItems: 'start' }}>
            <div className="rv">
              ...
              <p style={{ color: '#52606b', fontSize: '1.1rem', marginTop: 14, maxWidth: 680 }}>
                Clogged or failing gutters are the #1 cause of preventable roof and foundation damage. We repair, realign, and replace. In Dallas, GA (Paulding County) we bring the same local crew, the same warranty,
            ...
            <div className="rv">
              <img src="/assets/service-gutters-main.webp" alt="Gutter Repair & Replacement in Dallas, GA by iRoofer Contractors" loading="lazy" style={{ borderRadius: 8, border: '1px solid rgba(22,29,37,.1)', width: '100%', marginBottom: 24 }} />
        ...
        <div className="wrap">
          ...
          <div className="faq-list rv">
              <div className={faqItem(true)}>
                <button className="faq-q" aria-expanded={true}>{"Do you offer gutter repair & replacement in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
                <div className="faq-a"><div><p>{"Yes. Gutter Repair & Replacement is one of our core services across Paulding County and the greater Atlanta metro. As the town we call home, Dallas homeowners get priority scheduling and the crew chief on every job."}</p></div></div>
              </div>
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"How fast can you start a gutter repair & replacement job in Dallas?"}<span className="pm" aria-hidden="true" /></button>
              ...
              <div className={faqItem(false)}>
                <button className="faq-q" aria-expanded={false}>{"What does gutter repair & replacement cost in Dallas, GA?"}<span className="pm" aria-hidden="true" /></button>
